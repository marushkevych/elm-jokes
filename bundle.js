	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Chuck Norris jokes generator')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onClick(_user$project$Main$GetJoke)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Get New Joke')
							]))
					])),
				A2(
...
var _user$project$Main$randomJoke = function () {
	...
	var task = A2(_evancz$elm_http$Http$get, _user$project$Main$decoder, url);
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Joke':
				return {ctor: '_Tuple2', _0: _p0._0.joke, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Fail':
				return {
					ctor: '_Tuple2',
			...
			default:
				return {ctor: '_Tuple2', _0: 'fetching a joke...', _1: _user$project$Main$randomJoke};
		}
	});
